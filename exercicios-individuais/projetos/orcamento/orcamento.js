...
const calcularSubtotal = (quantidade) => quantidade * rnPrecoPorPagina;
...
function gerarValorTotal(){
    ...
    const porcentagem = Number(inputDesconto.value);
    ...
    const valorDesconto = calcularValorDesconto((subtotal + valorDesign + taxaUrgencia), porcentageDesconto);
